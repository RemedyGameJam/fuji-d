...
* @return None.
*/
extern (C) void function() MFCollision_DebugDraw;
...
* @return None.
*/
extern (C) void function(ref const(MFVector) p0, ref const(MFVector) p1, ref const(MFVector) p2, MFCollisionTriangle* pTri) MFCollision_MakeCollisionTriangleFromPoints;
...
*/
extern (C) MFCollisionItem* function(ref const(MFVector) rayPos, ref const(MFVector) rayDir, MFCollisionItem* pItem, MFRayIntersectionResult* pResult) MFCollision_RayTest;
...
*/
extern (C) MFCollisionItem* function(ref const(MFVector) spherePos, float radius, MFCollisionItem* pItem, MFCollisionResult* pResult) MFCollision_SphereTest;
...
*/
extern (C) MFCollisionItem* function(ref const(MFVector) sweepSpherePos, ref const(MFVector) sweepSphereVelocity, float sweepSphereRadius, MFCollisionItem* pItem, MFSweepSphereResult* pResult) MFCollision_SweepSphereTest;
...
*/
extern (C) bool function(ref const(MFVector) rayPos, ref const(MFVector) rayDir, ref const(MFVector) plane, float slabHalfWidth, MFRayIntersectionResult* pResult = null) MFCollision_RaySlabTest;
...
*/
extern (C) bool function(ref const(MFVector) rayPos, ref const(MFVector) rayDir, ref const(MFVector) spherePos, float radius, MFRayIntersectionResult* pResult = null) MFCollision_RaySphereTest;
...
*/
extern (C) bool function(ref const(MFVector) rayPos, ref const(MFVector) rayDir, ref const(MFVector) cylinderPos, ref const(MFVector) cylinderDir, float cylinderRadius, bool capped, MFRayIntersectionResult* pResult = null, float* pCylinderTime = null) MFCollision_RayCylinderTest;
...
*/
extern (C) bool function(ref const(MFVector) rayPos, ref const(MFVector) rayDir, ref const(MFVector) capsulePos, ref const(MFVector) capsuleDir, float capsuleRadius, MFRayIntersectionResult* pResult = null) MFCollision_RayCapsuleTest;
...
*/
extern (C) bool function(ref const(MFVector) rayPos, ref const(MFVector) rayDir, ref const(MFVector) boxPos, ref const(MFVector) boxRadius, MFRayIntersectionResult* pResult = null) MFCollision_RayBoxTest;
...
*/
extern (C) bool function(ref const(MFVector) spherePos, float radius, ref const(MFVector) plane, MFCollisionResult* pResult) MFCollision_SpherePlaneTest;
...
*/
extern (C) bool function(ref const(MFVector) pos1, float radius1, ref const(MFVector) pos2, float radius2, MFCollisionResult* pResult) MFCollision_SphereSphereTest;
...
* @return Returns true if the spheres intersect.
*/
extern (C) bool function(ref const(MFVector) sweepSpherePos, ref const(MFVector) sweepSphereVelocity, float sweepSphereRadius, ref const(MFVector) sphere, float sphereRadius, MFSweepSphereResult* pResult) MFCollision_SweepSphereSphereTest;
...
*/
extern (C) bool function(ref const(MFVector) sweepSpherePos, ref const(MFVector) sweepSphereVelocity, float sweepSphereRadius, ref const(MFCollisionTriangle) tri, MFSweepSphereResult* pResult) MFCollision_SweepSphereTriTest;
...
*/
extern (C) MFCollisionItem* function(const char* pItemName, int numTris) MFCollision_CreateDynamicCollisionMesh;
...
*/
extern (C) MFCollisionTriangle* function(MFCollisionItem* pDynamicCollisionMesh) MFCollision_LockDynamicCollisionMeshTriangleBuffer;
...
*/
extern (C) void function(MFCollisionItem* pDynamicCollisionMesh) MFCollision_UnlockDynamicCollisionMeshTriangleBuffer;
...
* @return None.
*/
extern (C) void function(MFCollisionItem* pItem) MFCollision_DestroyDynamicCollisionItem;
...
*/
extern (C) MFCollisionItem* function(const char* pFieldName, int maximumItemCount, ref const(MFVector) cellSize) MFCollision_CreateField;
...
* @return None.
*/
extern (C) void function(MFCollisionItem* pField, MFCollisionItem* pItem, uint itemFlags) MFCollision_AddItemToField;
...
* @return None.
*/
extern (C) void function(MFCollisionItem* pField, MFModel* pModel) MFCollision_AddModelToField;
...
*/
extern (C) void function(MFCollisionItem* pField) MFCollision_BuildField;
...
* @return None.
*/
extern (C) void function(MFCollisionItem* pField) MFCollision_ClearField;
...
* @return None.
*/
extern (C) void function(MFCollisionItem* pField) MFCollision_DestroyField;
...
static this()
{
	FindFujiFunction!MFCollision_DebugDraw;
	FindFujiFunction!MFCollision_MakeCollisionTriangleFromPoints;
	FindFujiFunction!MFCollision_RayTest;
	FindFujiFunction!MFCollision_SphereTest;
	FindFujiFunction!MFCollision_SweepSphereTest;
	FindFujiFunction!MFCollision_RaySlabTest;
	FindFujiFunction!MFCollision_RaySphereTest;
	FindFujiFunction!MFCollision_RayCylinderTest;
	FindFujiFunction!MFCollision_RayCapsuleTest;
	FindFujiFunction!MFCollision_RayBoxTest;
	FindFujiFunction!MFCollision_SpherePlaneTest;
	FindFujiFunction!MFCollision_SphereSphereTest;
	FindFujiFunction!MFCollision_SweepSphereSphereTest;
	FindFujiFunction!MFCollision_SweepSphereTriTest;
	FindFujiFunction!MFCollision_CreateDynamicCollisionMesh;
	FindFujiFunction!MFCollision_LockDynamicCollisionMeshTriangleBuffer;
	FindFujiFunction!MFCollision_UnlockDynamicCollisionMeshTriangleBuffer;
	FindFujiFunction!MFCollision_DestroyDynamicCollisionItem;
	FindFujiFunction!MFCollision_CreateField;
	FindFujiFunction!MFCollision_AddItemToField;
	FindFujiFunction!MFCollision_AddModelToField;
	FindFujiFunction!MFCollision_BuildField;
	FindFujiFunction!MFCollision_ClearField;
	FindFujiFunction!MFCollision_DestroyField;
}
