...
*/
extern (C) bool function(int device, int deviceID) MFInput_IsAvailable;
...
*/
extern (C) bool function(int device, int deviceID) MFInput_IsConnected;
...
*/
extern (C) bool function(int device, int deviceID) MFInput_IsReady;
...
*/
extern (C) float function(int button, int device, int deviceID = 0, float *pPrevState = null) MFInput_Read;
...
*/
extern (C) bool function(int button, int device, int deviceID = 0) MFInput_WasPressed;
...
*/
extern (C) bool function(int button, int device, int deviceID = 0) MFInput_WasReleased;
...
*/
extern (C) uint function(int device, int deviceID = 0) MFInput_GetDeviceFlags;
...
*/
extern (C) int function() MFInput_GetNumGamepads;
...
*/
extern (C) int function() MFInput_GetNumKeyboards;
...
*/
extern (C) int function() MFInput_GetNumPointers;

/**
*
*/
extern (C) int function() MFInput_GetNumAccelerometers;

/**
*
*/
extern (C) int function() MFInput_GetNumTouchPanels;
...
*/
extern (C) MFVector function(int mouseID = -1) MFInput_ReadMousePos;
...
*/
extern (C) MFVector function(int mouseID = -1) MFInput_ReadMouseDelta;
...
* @return None.
*/
extern (C) void function(int mode) MFInput_SetMouseMode;
...
* @return None.
*/
extern (C) void function(float multiplier) MFInput_SetMouseAcceleration;
...
* @return None.
*/
extern (C) void function(int mouseID, ref const(MFRect) rect) MFInput_SetMouseClippingRect;
...
*/
extern (C) const(char*) function(int button, int device, int deviceID = 0, bool includeDevice = false, bool includeDeviceID = false) MFInput_EnumerateString;
...
* @return None.
*/
extern (C) void function(float deadZone) MFInput_SetDeadZone;
...
*/
extern (C) float function() MFInput_GetDeadZone;
...
*/
extern (C) const(char*) function(int device, int deviceID) MFInput_GetDeviceName;
...
*/
extern (C) const(char*) function(int button, int deviceID) MFInput_GetGamepadButtonName;
...
*/
extern (C) bool function(int keyboardState, int keyboardID = -1) MFInput_GetKeyboardStatusState;

/**
*
*/
extern (C) char function(int key, bool shift, bool caps) MFInput_KeyToAscii;
...
*
*/
extern (C) MFTouchPanelState* function(int touchPanel) MFInput_GetContactInfo;
...
template Touch_XPos(contact)	{ enum MFTouchPanelInput Touch_XPos = MFTouchPanelInput.Touch_Contact0_XPos + (MFTouchPanelInput.Touch_Contact1_XPos - MFTouchPanelInput.Touch_Contact0_XPos)*contact; }
template Touch_YPos(contact)	{ enum MFTouchPanelInput Touch_YPos = MFTouchPanelInput.Touch_Contact0_YPos + (MFTouchPanelInput.Touch_Contact1_YPos - MFTouchPanelInput.Touch_Contact0_YPos)*contact; }
template Touch_XDelta(contact)	{ enum MFTouchPanelInput Touch_XDelta = MFTouchPanelInput.Touch_Contact0_XDelta + (MFTouchPanelInput.Touch_Contact1_XDelta - MFTouchPanelInput.Touch_Contact0_XDelta)*contact; }
template Touch_YDelta(contact)	{ enum MFTouchPanelInput Touch_YDelta = MFTouchPanelInput.Touch_Contact0_YDelta + (MFTouchPanelInput.Touch_Contact1_YDelta - MFTouchPanelInput.Touch_Contact0_YDelta)*contact; }
...
static this()
{
	FindFujiFunction!MFInput_IsAvailable;
	FindFujiFunction!MFInput_IsConnected;
	FindFujiFunction!MFInput_IsReady;
	FindFujiFunction!MFInput_Read;
	FindFujiFunction!MFInput_WasPressed;
	FindFujiFunction!MFInput_WasReleased;
	FindFujiFunction!MFInput_GetDeviceFlags;
	FindFujiFunction!MFInput_GetNumGamepads;
	FindFujiFunction!MFInput_GetNumKeyboards;
	FindFujiFunction!MFInput_GetNumPointers;
	FindFujiFunction!MFInput_GetNumAccelerometers;
	FindFujiFunction!MFInput_GetNumTouchPanels;
	FindFujiFunction!MFInput_ReadMousePos;
...
//	FindFujiFunction!MFInput_SetMouseClippingRect;
	...
	FindFujiFunction!MFInput_GetDeviceName;
	FindFujiFunction!MFInput_GetGamepadButtonName;
	FindFujiFunction!MFInput_GetKeyboardStatusState;
	FindFujiFunction!MFInput_KeyToAscii;
	FindFujiFunction!MFInput_GetContactInfo;
}
